...
function displayWindowForSetAPL(marker,event) {
	...
	latlng=latlng[0]+"$"+latlng[1];	
	  ...
	  message=message+'<option value=<%=area.getId()%>><%=area.getArea()%>';
...
Site site = (Site)request.getSession().getAttribute("siteById");	 

String[] city=new String[2];
city[0]  = ""+site.getLandmarkBean().getLatitude();
city[1] = ""+site.getLandmarkBean().getLongitude();
