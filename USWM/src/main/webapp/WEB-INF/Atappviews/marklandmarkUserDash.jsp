...
function showExistingLandmarks(){
	...
	if(place!="null")
		...
		{
		url="getLandmarksByLandmarkId?landmarkId="+landmarkId;
		}
	else
		{
		url="getLandmarks";
...
return xmlHttp;
  			...
  			<%           
	            ...
	            String landmarkId=(String)request.getAttribute("landmarkId");
...
<input type="hidden" value="<%=landmarkId%>" id="landmarkId">
